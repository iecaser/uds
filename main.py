...
def parse_input():
    ...
    p.add_argument('method', type=str,
                   choices={'Random', 'DualDensity', 'Distance', 'UncertaintyDistance', 'UncertaintyDualDensity', 'CoreSet', 'CoreSetMIP', 'Discriminative', 'DiscriminativeLearned', 'DiscriminativeAE',
