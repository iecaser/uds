...
def parse_input():
    ...
    p.add_argument('method', type=str,
                   choices={'Random', 'DualDensity', 'DualDensityBeam2', 'DualDensityBeam3', 'DualDensityBeam4', 'Distance', 'UncertaintyDistance', 'UncertaintyDualDensity', 'DynamicUncertaintyDualDensity', 'CoreSet', 'CoreSetMIP', 'Discriminative', 'DiscriminativeLearned', 'DiscriminativeAE',
    ...
    p.add_argument('--method2', '-method2', type=str,
                   choices={None, 'Random', 'CoreSet', 'CoreSetMIP', 'Discriminative', 'DiscriminativeLearned', 'DiscriminativeAE',
...
def evaluate_sample(training_function, X_train, Y_train, X_test, Y_test, checkpoint_path):
    ...
    model = training_function(X_train, Y_train, X_validation,
                              Y_validation, checkpoint_path, gpu=args.gpu)
...
if __name__ == '__main__':
    ...
    if args.initial_idx_path is not None:
        idx_path = os.path.join(args.initial_idx_path, '{exp}_{size}_{data}.pkl'.format(
            exp=args.experiment_index, size=args.initial_size, data=args.data_type))
    ...
    if args.method == 'Random':
        ...
        method = DualDensity
    elif args.method == 'DualDensityBeam2':
        method = DualDensityBeam2
    elif args.method == 'DualDensityBeam3':
        method = DualDensityBeam3
    elif args.method == 'DualDensityBeam4':
        method = DualDensityBeam4
    elif args.method == 'Distance':
        method = Distance
    elif args.method == 'UncertaintyDistance':
        method = UncertaintyDistance
